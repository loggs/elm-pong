...
var _user$project$Main$score_ = F2(
	function (scoreValue, person) {
		var _p0 = function () {
			var _p1 = person;
			if (_p1.ctor === 'Player') {
				return {ctor: '_Tuple2', _0: '50px', _1: 'text-right'};
			} else {
				return {ctor: '_Tuple2', _0: '845px', _1: 'text-left'};
			}
		}();
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'col-sm-3 ', classAddition)),
				_1: {
					ctor: '::',
			...
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(person)),
				_1: {
					ctor: '::',
					_0: A2(
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(scoreValue)),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _user$project$Main$ball_ = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
								...
								_1: {
									...
									_0: {
										...
										_1: A2(
											...
											_elm_lang$core$Basics$toString(model.ballX),
											'px')
									},
									_1: {
										ctor: '::',
										_0: {
											...
											_1: A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(model.ballY),
												'px')
										},
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$heading = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
...
var _user$project$Main$negOneOrOne = function (randInt) {
	return (_elm_lang$core$Native_Utils.cmp(randInt, 50) > 0) ? 1.0 : -1.0;
};
var _user$project$Main$updateBallDirection = F2(
	function (zeroOrOne, modelDirection) {
		var _p4 = zeroOrOne;
		if (_p4 === 1) {
...
var _user$project$Main$onUserInput = F2(
	function (keyMsg, model) {
		var keyboardModel = A2(_ohanhi$keyboard_extra$Keyboard_Extra$update, keyMsg, model.keyboardModel);
		var playerDir = (_elm_lang$core$Native_Utils.cmp(
			_ohanhi$keyboard_extra$Keyboard_Extra$arrows(keyboardModel).x,
			0) > 0) ? _user$project$Main$Right : ((_elm_lang$core$Native_Utils.cmp(
			_ohanhi$keyboard_extra$Keyboard_Extra$arrows(keyboardModel).x,
			0) < 0) ? _user$project$Main$Left : _user$project$Main$Still);
		var computerDir = (_elm_lang$core$Native_Utils.cmp(
			_ohanhi$keyboard_extra$Keyboard_Extra$wasd(keyboardModel).x,
			0) > 0) ? _user$project$Main$Right : ((_elm_lang$core$Native_Utils.cmp(
			_ohanhi$keyboard_extra$Keyboard_Extra$wasd(keyboardModel).x,
			0) < 0) ? _user$project$Main$Left : _user$project$Main$Still);
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{keyboardModel: keyboardModel, playerDirection: playerDir, computerDirection: computerDir}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Main$checkBoundaries = F3(
	function (position, change, dir) {
		var _p5 = _elm_lang$core$Native_Utils.eq(dir, _user$project$Main$Left) ? {
			ctor: '_Tuple3',
			_0: 0,
			_1: F2(
				function (x, y) {
		...
		} : (_elm_lang$core$Native_Utils.eq(dir, _user$project$Main$Right) ? {
			ctor: '_Tuple3',
			_0: 400,
			_1: F2(
				function (x, y) {
...
var _user$project$Main$checkGoalScored = function (model) {
	...
	var newBallDirX = _p6._0;
	var newBallDirY = _p6._1;
	var firstSeed = _mgold$elm_random_pcg$Random_Pcg$initialSeed(
		_elm_lang$core$Basics$round(model.ballX * 1243433.3123443243));
	var _p7 = A2(
		_mgold$elm_random_pcg$Random_Pcg$step,
		A2(_mgold$elm_random_pcg$Random_Pcg$int, 0, 100),
		firstSeed);
	var randX = _p7._0;
	var newSeed = _p7._1;
	var _p8 = A2(
...
var _user$project$Main$NewBallDirectionX = function (a) {
	return {ctor: 'NewBallDirectionX', _0: a};
};
var _user$project$Main$Step = function (a) {
	return {ctor: 'Step', _0: a};
};
var _user$project$Main$KeyboardExtraMsg = function (a) {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$KeyboardExtraMsg, _ohanhi$keyboard_extra$Keyboard_Extra$subscriptions),
			_1: {
				ctor: '::',
